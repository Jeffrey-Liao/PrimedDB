...
Furthermore, the primed feature can also apply on complex data like class. The primed database will deal with class object not with attributes but entire object.
